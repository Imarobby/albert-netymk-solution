...
public class TextComponentDemo extends JFrame {
	// the main parts of this frame
	JMenuBar mb = new JMenuBar();
	JTextPane textPane;
	JTextArea changeLog;
	JPanel statusPane = new JPanel(new GridLayout(1, 1));
	JLabel statusPaneLabel = new JLabel("Caret Status");
	...
	public TextComponentDemo() {
		...
		// Create actions after the configuration of text pane
		...
		statusPane.add(statusPaneLabel);
				...
				public void run() {
					if (dot == mark) { // no selection
						try {
							...
							statusPaneLabel.setText("caret: text position: "
									+ dot + ", view location = ["
						...
						statusPaneLabel.setText("selection from: " + dot
								+ " to " + mark + newline);
					} else {
						statusPaneLabel.setText("selection from: " + mark
								+ " to " + dot + newline);
					}
				}
			});
